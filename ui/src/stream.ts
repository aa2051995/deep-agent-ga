...
// The API base resolution lives in ./apiUrl (a dependency-free module) so api.ts
// and stream.ts share ONE DEFAULT_API_URL. Re-exported here for existing imports.
export { DEFAULT_API_URL, defaultApiBase, resolveApiUrl } from "./apiUrl";
